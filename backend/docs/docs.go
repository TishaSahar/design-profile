...
const docTemplate = `{
    ...
    "paths": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handler.updateContactsBody"
                        }
                    }
                ],
                "responses": {
        ...
        "/admin/projects": {
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "file",
                        "description": "Media files (images)",
                        "name": "media",
                        "in": "formData"
                    }
                ],
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handler.updateProjectBody"
                        }
                    }
                ],
                "responses": {
        ...
        "/admin/projects/{id}/media/{mediaId}": {
            "delete": {
                "security": [
                    {
                        "BearerAuth": []
        ...
        "/admin/requests/{id}/attachments/{attachmentId}": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handler.requestOTPBody"
                        }
                    }
                ],
                "responses": {
        ...
        "/requests": {
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Contact info (phone/email/telegram)",
                        "name": "contact",
                        "in": "formData",
                        "required": true
                    },
                    ...
                    {
                        "type": "file",
                        "description": "Attachments (up to 10 images or 1 PDF)",
                        "name": "attachments",
                        "in": "formData"
                    }
                ],
